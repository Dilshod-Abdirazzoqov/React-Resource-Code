  ...
  return (
    <div className="App">
       ...
       {showModal && <Modal closeModal={closeModal}>
          <h2>Dilshod Web Youtube Channel❤️</h2>
          <p>Lorem ipsum dolor sit amet consectetur, Sapiente porro amet iure ex ullam nemo sint nobis facere fugit. Quam nobis blanditiis non ipsum, numquam, sunt eveniet tempora culpa velit libero dolore eos rerum debitis similique esse tenetur maxime eaque laborum ad doloremque, alias vel. Dicta temporibus at architecto quis?</p>
          <a href="">Subscribe</a>
        </Modal>}
    </div>
  );
